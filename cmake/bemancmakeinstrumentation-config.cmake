...
function(configure_beman_cmake_instrumentation)
    if(NOT BEMAN_CMAKE_INSTRUMENTATION_CONFIGURATION)
        ...
        message(
            WARNING
            "using callback script ${BB_CMAKE_INSTRUMENTATION_DIR}/instrumentation.sh"
        )

        # Mark task as done in cache
        set(BEMAN_CMAKE_INSTRUMENTATION_CONFIGURATION
            TRUE
            CACHE INTERNAL
            "Flag to ensure CMake Instrumentation configured only once"
        )
    endif()
